...
import { Result } from '../../dist/pokemons/interfaces/pokeapi.response';
...
describe('PokemonsService', () => {
  ...
  it("shoul return 404 error if pokemon does't exist",async () => {
  ...
  it('should chech properties of th pokemon',async () =>{
    const id = 4;
  ...
  it('should find all polemons and cache them', async () => {
    ...
    expect(service.paginatedPokemonsCache.has(
    '10-1'
    )).toBeTruthy();
    expect(service.paginatedPokemonsCache.get(
    '10-1'
    )).toBe(pokemons);
